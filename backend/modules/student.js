...
const insertStudent = (studentData, callback) => {
    const query = `
        INSERT INTO student (USN, Name, Department, Gender, Date_of_Birth, Email, Secondary_Email, Phone_Number, 10th_Percentage, 12th_Diploma_Percentage, BE_CGPA, Active_Backlogs, History_of_Backlogs)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `;
    const values = [
        studentData.USN,
